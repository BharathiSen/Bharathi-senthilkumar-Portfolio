    ...
    const handleBack = () => {
      try {
        ...
        if (window.opener && !window.opener.closed) {
          // focus and navigate opener to projects then close this tab
          try { window.opener.location.href = `${window.opener.location.pathname}#projects`; } catch { window.opener.location.hash = '#projects'; }
          window.opener.focus();
          window.close();
          return;
        }
        // fallback: navigate this tab to the main site projects section
